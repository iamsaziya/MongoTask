  ...
  document.querySelector("#sidebar").innerHTML = `
    ...
    <aside>
      <nav>
        <ul>
        <li><h2>MT</h2></li>
          <li><a href="index.html"><span><svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960"
          ...
          <li><a href="calender.html"> <span><svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960"
                  width="24px" fill="currentColor">
                  <path
          ...
          <li><a href="user.html"><span><svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960"
                  width="24px" fill="currentColor">
                  <path
